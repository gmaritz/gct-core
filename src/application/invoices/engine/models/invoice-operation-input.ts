...
export type InvoiceOperationInput =
  | InvoiceCreateOperationInput
  | InvoiceIssueOperationInput
  | InvoicePaymentOperationInput
  | InvoiceCancellationOperationInput
  | InvoiceVoidOperationInput
  | InvoiceRefundOperationInput;
