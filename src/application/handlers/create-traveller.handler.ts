 ...
 */
export class CreateTravellerHandler {
  constructor(private readonly service: CreateTravellerService) {}

  async handle(command: CreateTravellerCommand): Promise<TravellerDTO> {
