...
exports.PaymentPolicyRegistry = void 0;
const models_1 = require("./models");
function priorityWeight(priority) {
    switch (priority) {
        case models_1.PaymentPolicyPriority.CRITICAL:
            return 0;
        case models_1.PaymentPolicyPriority.HIGH:
            return 1;
        case models_1.PaymentPolicyPriority.NORMAL:
            return 2;
        case models_1.PaymentPolicyPriority.LOW:
            return 3;
        default:
            return 4;
    }
...
class PaymentPolicyRegistry {
    constructor() {
        this.policies = new Map();
        this.registrationSequence = 0;
    }
    register(name, policy, priority = models_1.PaymentPolicyPriority.NORMAL) {
...
exports.PaymentPolicyRegistry = PaymentPolicyRegistry;
//# sourceMappingURL=payment-policy-registry.js.map