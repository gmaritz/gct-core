...
exports.PricingPolicyRegistry = void 0;
const models_1 = require("./models");
function priorityWeight(priority) {
    switch (priority) {
        case models_1.PricingPolicyPriority.CRITICAL:
            return 0;
        case models_1.PricingPolicyPriority.HIGH:
            return 1;
        case models_1.PricingPolicyPriority.NORMAL:
            return 2;
        case models_1.PricingPolicyPriority.LOW:
            return 3;
        default:
            return 4;
    }
...
class PricingPolicyRegistry {
    ...
    register(name, policy, priority = models_1.PricingPolicyPriority.NORMAL) {
...
exports.PricingPolicyRegistry = PricingPolicyRegistry;
//# sourceMappingURL=pricing-policy-registry.js.map