export declare enum InvoiceEngineErrorCode {
...
export declare function createInvoiceEngineError(error: InvoiceEngineError): InvoiceEngineError;
//# sourceMappingURL=invoice-engine-error.d.ts.map