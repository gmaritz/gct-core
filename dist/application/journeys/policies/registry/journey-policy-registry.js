...
exports.JourneyPolicyRegistry = void 0;
const models_1 = require("../models");
function priorityWeight(priority) {
    switch (priority) {
        case models_1.JourneyPolicyPriority.CRITICAL:
            return 0;
        case models_1.JourneyPolicyPriority.HIGH:
            return 1;
        case models_1.JourneyPolicyPriority.NORMAL:
            return 2;
        case models_1.JourneyPolicyPriority.LOW:
            return 3;
        default:
            return 4;
    }
...
class JourneyPolicyRegistry {
    constructor() {
        this.policies = new Map();
        this.registrationSequence = 0;
    }
    register(name, policy, priority = models_1.JourneyPolicyPriority.NORMAL) {
...
exports.JourneyPolicyRegistry = JourneyPolicyRegistry;
//# sourceMappingURL=journey-policy-registry.js.map